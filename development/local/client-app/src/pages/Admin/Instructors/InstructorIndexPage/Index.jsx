...
import {findAll} from "../../../../services/new/instructor/admin/instructor-service.js";

const metaData = {
    title: 'Data Instruktur',
};

export const InstructorIndexPage = () => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                const getAllInstructors = await findAll(currentPage);

                if (getAllInstructors.success) {
                    setData(getAllInstructors.data.data);
                    setPagination(getAllInstructors.data.pagination);
                }
                    ...
                    <div className="row pb-50">
                        <div className="col-12">
                            <div>
                                ...
                                <div className="mt-10">
                                    Lihat data-data instruktur yang terdaftar.
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <tbody>
                                                    {
                                                        data.map((item, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td>
                                                                    <Link to={`/admin/instructors/${item.instructor.id}`}>
                                                                        Detail
                                                                    </Link>
                                                                </td>
                                                            </tr>
