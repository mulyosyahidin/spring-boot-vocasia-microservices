...
import {findLatestCourses} from "../../../../../services/new/course/public/course-service.js";
...
export const CourseItems = () => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                const getEditorChoiceCourses = await findLatestCourses();

                if (getEditorChoiceCourses.success) {
                    setCourses(getEditorChoiceCourses.data.data);
