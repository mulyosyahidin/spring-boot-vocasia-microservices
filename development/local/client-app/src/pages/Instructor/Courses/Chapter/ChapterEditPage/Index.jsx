...
import {createChapter, findById, updateChapter} from "../../../../../services/new/course/instructor/chapter-service.js";
...
export const ChapterEditPage = () => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                const findChapterById = await findById(id, chapterId);

                if (findChapterById.success) {
                    setFormData({
                        title: findChapterById.data.chapter.title,
                        total_duration: findChapterById.data.chapter.total_duration,
                    });
                }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const doUpdateChapter = await updateChapter(id,chapterId, formData);

            if (doUpdateChapter.success) {
                await withReactContent(Swal).fire({
                    title: 'Berhasil!',
                    text: doUpdateChapter.message,
                    icon: 'success',
                });
                ...
                <div className="dashboard__content bg-light-4">
                    <div className="row pb-50 mb-10">
                        <div className="col-auto">
                            <h1 className="text-30 lh-12 fw-700">Edit Bab Kursus</h1>
                        </div>
                    </div>
