...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity serverHttpSecurity) {
        serverHttpSecurity.authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers(HttpMethod.GET, "/catalog/public/categories/only-parents").permitAll()
                        .pathMatchers(HttpMethod.GET, "/catalog/public/courses/{courseSlug}/{courseId}").permitAll()
                        .pathMatchers(HttpMethod.GET, "/catalog/public/courses/latests").permitAll()
                )
