...
import com.vocasia.instructor.service.IOrderService;
import com.vocasia.instructor.service.client.OrderFeignClient;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public OrderItemDto findOrderItemById(Long orderId, Long courseId, String correlationId) {
        try {
            ResponseEntity<ResponseDto> orderFeignClientFindOrderItemByIdResponseEntity = orderFeignClient.findOrderItemById(correlationId, orderId, courseId);
            ResponseDto responseBody = orderFeignClientFindOrderItemByIdResponseEntity.getBody();
