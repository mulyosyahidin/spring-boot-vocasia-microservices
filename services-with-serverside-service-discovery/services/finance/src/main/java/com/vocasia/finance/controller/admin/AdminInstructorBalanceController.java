...
public class AdminInstructorBalanceController {

    private final Logger logger = LoggerFactory.getLogger(AdminInstructorBalanceController.class);
    ...
    public AdminInstructorBalanceController(IInstructorBalanceService iInstructorBalanceService, IInstructorBalanceHistoryService iInstructorBalanceHistoryService) {
    ...
    public ResponseEntity<ResponseDto> getData(@RequestHeader("vocasia-correlation-id") String correlationId,
        ...
        logger.info("AdminInstructorBalanceController.getData called");
