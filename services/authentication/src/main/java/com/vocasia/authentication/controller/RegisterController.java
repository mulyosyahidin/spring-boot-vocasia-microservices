...
public class RegisterController {
    ...
    public ResponseEntity<ResponseDto> register(@Valid @RequestBody RegisterRequest registerRequest)
        ...
        response.put("user", createUserDataMap(registeredUser));
    ...
    private Map<String, Object> createUserDataMap(User registeredUser) {
        Map<String, Object> userData = new HashMap<>();

        userData.put("id", registeredUser.getId());
        userData.put("uid", registeredUser.getUid());
        ...
        userData.put("profile_picture", registeredUser.getProfilePicture());
        userData.put("created_at", registeredUser.getCreatedAt());
        userData.put("updated_at", registeredUser.getUpdatedAt());
