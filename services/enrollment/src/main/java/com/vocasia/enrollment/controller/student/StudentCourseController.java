...
public class StudentCourseController {
    ...
    public StudentCourseController(IEnrollmentService iEnrollmentService, ICourseService iCourseService) {
    ...
    public ResponseEntity<ResponseDto> getEnrolledCourseDetail(@RequestHeader("vocasia-correlation-id") String correlationId,
                                                       @RequestHeader("X-USER-ID") Long userId, @PathVariable Long enrollmentId) {
        logger.info("StudentCourseController.getEnrolledCourseDetail called");
