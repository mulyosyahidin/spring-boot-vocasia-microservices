...
INSERT INTO `chapters` (`id`, `course_id`, `title`, `total_duration`, `created_at`, `updated_at`) VALUES
	...
	(38, 32, 'Bab 1', '01:00:00', '2024-12-15 14:59:03', NULL);
...
INSERT INTO `courses` (`id`, `instructor_id`, `category_id`, `title`, `slug`, `total_duration`, `level`, `language`, `description`, `short_description`, `featured_picture`, `price`, `is_free`, `is_discount`, `discount`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(32, 7, 12, 'TEST KURSUS', 'test-kursus', '01:00:00', 'beginner', 'id', '<p>deskripsi kursus</p>', '<p>deskripsi singkat</p>', '1734249530004-Akuntansi Keuangan Menengah 1.jpeg', 90000, b'0', b'0', 0, 'published', '2024-12-15 14:58:30', '2024-12-15 14:59:36', NULL);
...
-- Membuang data untuk tabel vocasia_db.enrollments: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.instructors: ~4 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.instructor_balance_histories: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.instructor_student_courses: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.instuctor_income: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.lessons: ~330 rows (lebih kurang)
INSERT INTO `lessons` (`id`, `chapter_id`, `title`, `type`, `need_previous_lesson`, `is_free`, `content_video_duration`, `content_video_url`, `content_text`, `attachment_file_name`, `attachment_file_url`, `attachment_link`, `attachment_link_name`, `attachment_type`, `created_at`, `updated_at`) VALUES
	...
	(149, 33, 'Digital Marketing Course Part - 1 ðŸ”¥| Digital Marketing Tutorial For Beginners | Simplilearn', 'video', b'1', b'0', '10j 50m 20d', 'https://www.youtube.com/watch?v=nU-IIXBWlS4', NULL, NULL, NULL, NULL, NULL, NULL, '2024-11-05 00:27:07', NULL),
	(150, 33, 'Digital Marketing Course Part - 2 ðŸ”¥ | Digital Marketing Tutorial For Beginners | Simplilearn', 'video', b'1', b'0', '10j 56m 40d', 'https://www.youtube.com/watch?v=fsDwHJa_xcE', NULL, NULL, NULL, NULL, NULL, NULL, '2024-11-05 00:27:07', NULL),
	(151, 33, 'Digital Marketing Course Part - 3 ðŸ”¥ | Digital Marketing Tutorial For Beginners | Simplilearn', 'video', b'1', b'0', '6j 58m 53d', 'https://www.youtube.com/watch?v=gNBXwFsNm-8', NULL, NULL, NULL, NULL, NULL, NULL, '2024-11-05 00:27:07', NULL),
	...
	(359, 38, 'Pelajaran 1', 'video', b'0', b'0', '01:00:00', 'https://www.youtube.com/watch?v=WqeszmCJv_0', '', NULL, NULL, NULL, NULL, NULL, '2024-12-15 14:59:22', NULL);
...
-- Membuang data untuk tabel vocasia_db.orders: ~4 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.order_items: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.platform_balance_histories: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.platform_income: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.progress: ~0 rows (lebih kurang)
...
-- Membuang data untuk tabel vocasia_db.users: ~7 rows (lebih kurang)
