...
export const Contents = ({ activeTab,courseId, course }) => {
                                ...
                                <div className="accordion__content__inner px-30 py-30">
                                    {
                                        chapter.lessons.map((lesson, index) => (
                                            <div key={index}
                                                ...
                                                {
                                                    lesson.type === 'video' && (
                                                        <div className="icon icon-play cursor-pointer" onClick={() => handleOpenModal(getYouTubeVideoId(lesson.content_video_url))}></div>
                                                    )
                                                }
