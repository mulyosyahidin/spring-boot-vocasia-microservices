        ...
        <div className="w-1/5 p-4">
            ...
            <div className="pt-15">
                ...
                <div className="progress-bar mt-10">
                    ...
                    <div className="progress-bar__bar bg-purple-1" style={{width: `${data.progress_percentage}%`}}
                    ></div>
                </div>

                <div className="d-flex y-gap-10 justify-between items-center mt-10">
                    <div className="text-dark-1 text-small">{data.progress_percentage}%</div>
                </div>
            </div>
        </div>
    );
