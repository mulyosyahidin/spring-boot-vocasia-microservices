...
import {INSTRUCTORS_COURSE_GET_INCOMES, INSTRUCTORS_COURSE_GET_STUDENTS} from "../../config/endpoints.js";
...
export const getCourseIncomesData = async (courseId) => {
    try {
        let endpoint = `${apiBaseUrl}${INSTRUCTORS_COURSE_GET_INCOMES}`;
        endpoint = endpoint.replace(':courseId', courseId);
